...
!(function (global, setTimeout) {
    var req, s, head, baseElement, dataMain, src, interactiveScript, currentlyAddingScript, mainScript, subPath, version = "2.3.6", commentRegExp = /\/\*[\s\S]*?\*\/|([^:"'=]|^)\/\/.*$/gm, cjsRequireRegExp = /[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g, jsSuffixRegExp = /\.js$/, currDirRegExp = /^\.\//, op = Object.prototype, ostring = op.toString, hasOwn = op.hasOwnProperty, isBrowser = !("undefined" == typeof window ||
        ...
        !window.document), isWebWorker = !isBrowser && "undefined" != typeof importScripts, readyRegExp = isBrowser && "PLAYSTATION 3" === navigator.platform
        ? /^complete$/
        : /^(complete|loaded)$/, defContextName = "_", isOpera = "undefined" != typeof opera && "[object Opera]" === opera.toString(), contexts = {}, cfg = {}, globalDefQueue = [], useInteractive = !1;
                ...
                e: for (o = (n = e.split("/")).length; 0 < o; o -= 1) {
                    if (((s = n.slice(0, o).join("/")), l))
                        for (a = l.length; 0 < a; a -= 1)
                            if ((r = getOwn(h, l.slice(0, a).join("/"))) &&
                                (r = getOwn(r, s))) {
                                (c = r), (d = o);
                                break e;
                            }
                            ...
                            return this.map.unnormalized
                                ? (e.normalize &&
                                    ...
                                    void ((i = getOwn(p, t.id)) &&
                                        (this.depMaps.push(t),
                                            this.events.error &&
                                                i.on("error", bind(this, function (e) {
                                                    this.emit("error", e);
                                                })),
                                            i.enable())))
                                : r
                            ...
                            if ("string" == typeof e) {
                                ...
                                (this.depCount += 1),
                                    ...
                                    this.errback
                                        ...
                                        : this.events.error &&
                                            M(e, "error", bind(this, function (e) {
                                                this.emit("error", e);
                                            }));
                            }
                            (i = e.id),
                                    ...
                                    : o && hasProp(c, e)
                                        ...
                                        : req.get
                                            ...
                                            : ((r = S(e, o, !1, !0).id),
                                                hasProp(m, r)
                                                    ? m[r]
                                                    : O(makeError("notloaded", 'Module name "' +
                                                        r +
                        ...
                        (a = n.join("/")),
                            (a =
                                ("/" ===
                                    (a +=
                                        t ||
                                            (/^data\:|^blob\:|\?/.test(a) || i ? "" : ".js")).charAt(0) || a.match(/^[\w\+\.\-]+:/)
                                    ? ""
                                    : g.baseUrl) + a);
                    }
                ...
                onScriptError: function (e) {
                    ...
                    if (!w(i.id)) {
                        ...
                        return (eachProp(p, function (e, t) {
                            ...
                            O(makeError("scripterror", 'Script error for "' +
                                i.id +
                                (r.length ? '", needed by: ' + r.join(", ") : '"'), e, [i.id])));
                    }
                },
