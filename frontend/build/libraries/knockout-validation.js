...
(function (factory) {
    ...
    var kv = ko.validation, koUtils = ko.utils, unwrap = koUtils.unwrapObservable, forEach = koUtils.arrayForEach, extend = koUtils.extend; /*global ko: false*/
    var defaults = {
            ...
            group: function group(obj, options) {
                ...
                result.isAnyMessageShown = function () {
                    ...
                    invalidAndModifiedPresent = !!result.find(function (observable) {
                        return (utils.isValidatable(observable) &&
                            !observable.isValid() &&
    ...
    kv.rules["date"] = {
        validator: function (value, validate) {
            ...
            return (kv.utils.isEmptyVal(value) ||
    ...
    ko.bindingHandlers["validationMessage"] = {
        ...
        update: function (element, valueAccessor) {
            var obsv = valueAccessor(), config = kv.utils.getConfigOptions(element), val = unwrap(obsv), msg = null, isModified = false, isValid = false;
    ...
    ko.extenders["validatable"] = function (observable, options) {
        ...
        if (options.enable && !kv.utils.isValidatable(observable)) {
            ...
            var h_obsValidationTrigger = ko.computed(extend({
                read: function () {
                    var obs = observable(), ruleContexts = observable.rules();
    ...
    kv.validateObservable = function (observable) {
        var i = 0, rule, // the rule validator to execute
