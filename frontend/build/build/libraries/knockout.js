        ...
        (function (n) { "function" === typeof define && define.amd ? define(["exports", "require"], n) : "object" === typeof exports && "object" === typeof module ? n(module.exports || exports) : n(A.ko = {}); })(function (S, T) {
            ...
            a.a = function () {
                ...
                return { Jc: ["authenticity_token", /^__RequestVerificationToken(_.*)?$/],
                    D: function (a, b, c) {
                        ...
                        for (var d = 0, e = a.length; d < e; d++)
                            if (b.call(c, a[d], d, a))
                                return a[d];
                        return n;
                    }, Pa: function (b, c) { var d = a.a.A(b, c); 0 < d ? b.splice(d, 1) : 0 === d && b.shift(); }, wc: function (b) { var c = []; b && a.a.D(b, function (b) { 0 > a.a.A(c, b) && c.push(b); }); return c; }, Mb: function (a, b, c) {
                        var d = [];
                        if (a)
                        ...
                        if (b instanceof Array)
                            ...
                            for (var c = 0, d = b.length; c < d; c++)
                                a.push(b[c]);
                        return a;
                    }, Na: function (b, c, d) { var e = a.a.A(a.a.bc(b), c); 0 > e ? d && b.push(c) : d || b.splice(e, 1); }, Ba: g, extend: c, setPrototypeOf: d, Ab: g ? d : c, P: b, Ga: function (a, b, c) {
                        if (!a)
                            return a;
                        var d = {}, e;
                        for (e in a)
                        ...
                        return a;
                    }, Zc: function (a, b) { 7 > p ? a.setAttribute("selected", b) : a.selected = b; }, Db: function (a) {
                        return null === a || a === n ? "" : a.trim ?
                            a.trim() : a.toString().replace(/^[\s\xa0]+|[\s\xa0]+$/g, "");
                    }, Ud: function (a, b) { a = a || ""; return b.length > a.length ? !1 : a.substring(0, b.length) === b; }, vd: function (a, b) {
                        if (a === b)
                            return !0;
                        if (11 === a.nodeType)
                            return !1;
                        ...
                        for (; a && a != b;)
                            a = a.parentNode;
                        return !!a;
                    }, Sb: function (b) { return a.a.vd(b, b.ownerDocument.documentElement); }, kd: function (b) { return !!a.a.Lb(b, a.a.Sb); }, R: function (a) {
                        return a &&
                    ...
                    }, setTimeout: function (b, c) { return setTimeout(a.a.Ac(b), c); }, Gc: function (b) { setTimeout(function () { a.onError && a.onError(b); throw b; }, 0); }, B: function (b, c, d) {
                        var e = a.a.Ac(d);
                        d = l[c];
                    ...
                    }, Ad: function (a) { 9 <= p && (a = 1 == a.nodeType ? a : a.parentNode, a.style && (a.style.zoom = a.style.zoom)); }, wd: function (a) {
                        if (p) {
                            var b = a.style.width;
                            a.style.width = 0;
                            a.style.width = b;
                        ...
                        for (var b = [], c = 0, d = a.length; c < d; c++)
                            b.push(a[c]);
                        return b;
                    }, Da: function (a) { return h ? Symbol(a) : a; }, Zd: 6 === p, $d: 7 === p, W: p, Lc: function (b, c) {
            ...
            var D = { qb: function (a) { a.U = { change: [] }; a.sc = 1; }, subscribe: function (b, c, d) { var e = this; d = d || "change"; var f = new a.ic(e, c ? b.bind(c) : b, function () { a.a.Pa(e.U[d], f); e.hb && e.hb(d); }); e.Qa && e.Qa(d); e.U[d] || (e.U[d] = []); e.U[d].push(f); return f; }, notifySubscribers: function (b, c) {
                    c = c || "change";
                    "change" === c && this.Gb();
                    if (this.Wa(c)) {
                ...
                Bd: function (b) {
                    ...
                    return c;
                }, sb: function (a, c) { return !this.equalityComparer || !this.equalityComparer(a, c); }, toString: function () { return "[object Object]"; }, extend: function (b) { var c = this; b && a.a.P(b, function (b, e) { var f = a.Ta[b]; "function" == typeof f && (c = f(c, e) || c); }); return c; } };
            a.L(D, "init", D.qb);
            ...
            a.S = a.u = function () {
                ...
                function c() { e = d.pop(); }
                var d = [], e, f = 0;
                return { xc: b, end: c, cc: function (b) {
                        if (e) {
                            if (!a.Qc(b))
            ...
            a.Ha.fn = { remove: function (b) {
                    ...
                    var c = this.v(), d = "function" != typeof b || a.O(b) ? function (a) { return a === b; } : b;
                    this.ya();
                    ...
                    this.xa();
                }, destroyAll: function (b) { return b === n ? this.destroy(function () { return !0; }) : b ? this.destroy(function (c) { return 0 <= a.a.A(b, c); }) : []; }, indexOf: function (b) { var c = this(); return a.a.A(c, b); }, replace: function (a, c) { var d = this.indexOf(a); 0 <= d && (this.ya(), this.v()[d] = c, this.xa()); }, sorted: function (a) {
                    var c = this().slice(0);
            ...
            var C = { equalityComparer: K, qa: function () { return this[r].V; }, Va: function () { var b = []; a.a.P(this[r].I, function (a, d) { b[d.Ka] = d.da; }); return b; }, Vb: function (b) {
                    if (!this[r].V)
                        return !1;
                    var c = this.Va();
                    return -1 !== a.a.A(c, b) ? !0 : !!a.a.Lb(c, function (a) { return a.Vb && a.Vb(b); });
                }, uc: function (a, c, d) {
                    if (this[r].wb &&
                        c === this)
                    ...
                    for (a in d)
                        if (Object.prototype.hasOwnProperty.call(d, a) && (c = d[a], this.Ia && c.da.Ja || c.da.Dd(c.La)))
                            return !0;
                }, Jd: function () { this.Ia && !this[r].rb && this.Ia(!1); }, ja: function () { var a = this[r]; return a.ka || 0 < a.V; }, Rd: function () { this.Ja ? this[r].ka && (this[r].sa = !0) : this.Hc(); }, $c: function (a) {
                    if (a.Hb) {
                ...
                }, Hc: function () { var b = this, c = b.throttleEvaluation; c && 0 <= c ? (clearTimeout(this[r].Ic), this[r].Ic = a.a.setTimeout(function () { b.ha(!0); }, c)) : b.Ia ? b.Ia(!0) : b.ha(!0); }, ha: function (b) {
            ...
            (function () {
                ...
                a.h = { ea: {}, childNodes: function (a) { return b(a) ? d(a) : a.childNodes; }, Ea: function (c) {
                        if (b(c)) {
                            c = a.h.childNodes(c);
                            for (var d = 0, e = c.length; d < e; d++)
                                a.removeNode(c[d]);
                    ...
                    }, Cd: b, Vd: function (a) { return (a = (f ? a.text : a.nodeValue).match(g)) ? a[1] : null; }, Sc: function (d) {
                        if (m[a.a.R(d)]) {
                            var f = d.firstChild;
                            if (f) {
                                do
            ...
            (function () {
                ...
                a.a.extend(a.ga.prototype, { nodeHasBindings: function (b) {
                    ...
                    }, getBindings: function (b, c) { var d = this.getBindingsString(b, c), d = d ? this.parseBindingsString(d, c, b) : null; return a.j.tc(d, b, c, !1); }, getBindingAccessors: function (b, c) { var d = this.getBindingsString(b, c), d = d ? this.parseBindingsString(d, c, b, { valueAccessors: !0 }) : null; return a.j.tc(d, b, c, !0); }, getBindingsString: function (b) {
                        switch (b.nodeType) {
            ...
            a.c.value = { init: function (b, c, d) {
                    ...
                    if (!f || "checkbox" != b.type && "radio" != b.type) {
                        ...
                        var p;
                        p = f && "file" == b.type ? function () { var d = a.a.f(c()); null === d || d === n || "" === d ? b.value = "" : a.u.G(l); } : function () {
