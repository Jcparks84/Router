...
function Route() {
    requirejs(["./pubsub"], function () {
            ...
            let newData = customers
                .map((c, i) => `<tr key=${i}>
                                    ...
                                    <td> ${Object.values(c.address).join(",")}</td>
                                        ...
                                        <td>${c.key}</td>
                                        <td>${c.cases}</td>
                                        <td style="display: none" >${c.driverNotes}</td>
                                     </tr>`)
                .join("");
        ...
        /////////////////////////////////// StopInfo Modal //////////////////////////////////
        const openCustomerModal = document.querySelectorAll("[data-customer-modal-target]");
        const closeCustomerModal = document.querySelectorAll("[data-close-button]");
        //   const importOverlay = document.getElementById("import-overlay");
        openCustomerModal.forEach((button) => {
            button.addEventListener("click", () => {
                const CustomerModal = document.querySelector(button.dataset.customerModalTarget);
