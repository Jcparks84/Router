...
(function (factory) {
  ...
  if (typeof ko === "undefined") {
    throw new Error(
      "Knockout is required, please ensure it is loaded before loading this validation plug-in"
    );
  }
  ...
  kv.utils = (function () {
    ...
    return {
      isArray: function (o) {
        return (
          o.isArray || Object.prototype.toString.call(o) === "[object Array]"
        );
      },
      isObject: function (o) {
      ...
      getOriginalElementTitle: function (element) {
        var savedOriginalTitle = kv.utils.getAttribute(
            element,
            "data-orig-title"
          ),
          currentTitle = element.title,
          hasSavedOriginalTitle = kv.utils.hasAttribute(
            element,
            "data-orig-title"
          );
  ...
  var api = (function () {
      ...
      if (level !== 0) {
        utils.forEach(objValues, function (observable) {
          ...
          if (
            observable &&
            !observable.nodeType &&
            (!ko.isComputed(observable) || observable.rules)
          ) {
    ...
    return {
      ...
      init: function (options, force) {
        ...
        options.errorElementClass =
          options.errorElementClass ||
          options.errorClass ||
          configuration.errorElementClass;
        options.errorMessageClass =
          options.errorMessageClass ||
          options.errorClass ||
          configuration.errorMessageClass;
      ...
      group: function group(obj, options) {
        ...
        result.isAnyMessageShown = function () {
          ...
          invalidAndModifiedPresent = !!result.find(function (observable) {
            return (
              utils.isValidatable(observable) &&
              !observable.isValid() &&
    ...
    return function (val, options) {
      ...
      switch (type.toLowerCase()) {
        case "week":
          ...
          if (valMatches === null) {
            throw new Error(
              "Invalid value for " +
                validatorName +
                " attribute for week input.  Should look like " +
          ...
          if (isMaxValidation) {
            return (
              valMatches[1] < comparisonValueMatches[1] || // older year
              // same year, older week
              (valMatches[1] === comparisonValueMatches[1] &&
                valMatches[2] <= comparisonValueMatches[2])
            );
          } else {
            return (
              valMatches[1] > comparisonValueMatches[1] || // newer year
        ...
        case "month":
          ...
          if (valMatches === null) {
            throw new Error(
              "Invalid value for " +
                validatorName +
                " attribute for month input.  Should look like " +
        ...
        case "range":
          if (isMaxValidation) {
            return (
              !isNaN(val) && parseFloat(val) <= parseFloat(comparisonValue)
            );
          } else {
            return (
              !isNaN(val) && parseFloat(val) >= parseFloat(comparisonValue)
  ...
  kv.rules["date"] = {
    validator: function (value, validate) {
      ...
      return (
        kv.utils.isEmptyVal(value) ||
        (validate && !/Invalid|NaN/.test(new Date(value)))
      );
    },
  ...
  kv.rules["unique"] = {
    validator: function (val, options) {
      ...
      koUtils.arrayFilter(c, function (item) {
        if (
          val === (options.valueAccessor ? options.valueAccessor(item) : item)
        ) {
          counter++;
        }
      });
  ...
  ko.bindingHandlers["validationMessage"] = {
    ...
    update: function (element, valueAccessor) {
      ...
      if (obsv === null || typeof obsv === "undefined") {
        throw new Error(
          "Cannot bind validationMessage to undefined value. data-bind expression: " +
  ...
  ko.bindingHandlers["validationElement"] = {
    update: function (element, valueAccessor, allBindingsAccessor) {
      ...
      if (obsv === null || typeof obsv === "undefined") {
        throw new Error(
          "Cannot bind validationElement to undefined value. data-bind expression: " +
            element.getAttribute("data-bind")
        );
      }
      ...
      var cssSettingsAccessor = function () {
        ...
        var shouldShow =
          !config.decorateElementOnModified || isModified ? !isValid : false;
  ...
  ko.extenders["validatable"] = function (observable, options) {
    ...
    if (options.enable && !kv.utils.isValidatable(observable)) {
      ...
      var h_obsValidationTrigger = ko.computed(
        extend(
          {
            read: function () {
              var obs = observable(),
  ...
  ko.validatedObservable = function (initialValue, options) {
    ...
    obsv.errors = kv.group(
      kv.utils.isObject(initialValue) ? initialValue : {},
      options
    );
